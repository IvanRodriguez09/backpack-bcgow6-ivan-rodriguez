...
func productTotal(products []Product, c chan float64) (total float64) {
...
func serviceTotal(services []Service, c chan float64) (total float64) {
...
func maintenanceTotal(maintenance []Maintenance, c chan float64) (total float64) {
